...
export const MAPS = [
  ...
  // ── 世界1の 後半（PLAN.md §4 の 面わりテンプレート）──────────
  //   6〜7面: ひねり（はじめは 不利）
  //   8〜9面: 総合（大きめの盤で 自由に たたかう）
  //   10面 : ボス面（その世界の 主役が 強敵として 出る）

  {
    ...
    stage: 6,
    name: 'かずで まけている',
    hint: '敵のほうが 数が 多い。岩場や 雑木林に 立つと 守りが かたくなるよ。むりに 出ていかないこと。',
    aiLevel: 1,
    // はじめは 不利。そのぶん お金は こちらが 多い。
    // 「まもって ためて 立てなおす」を おぼえる面。
    startFunds: { player: 8000, enemy: 6000 },
    incomePerProperty: 1000,
    rows: [
      '............',
      '.Q.N..S.....',
    ...
    units: [
      { x: 8, y: 10, type: 'ant', team: 'player' },
      { x: 9, y: 10, type: 'kabuto', team: 'player' },
      { x: 10, y: 10, type: 'mantis', team: 'player' },
      { x: 1, y: 2, type: 'ant', team: 'enemy' },
      { x: 2, y: 1, type: 'ant', team: 'enemy' },
      { x: 4, y: 1, type: 'ant', team: 'enemy' },
      { x: 3, y: 2, type: 'kabuto', team: 'enemy' },
      { x: 5, y: 1, type: 'mantis', team: 'enemy' },
    ],
    steps: [
      { on: 'start', text: '敵のほうが 数が 多い！ でも お金は こちらが 多いよ。' },
      { on: 'playerTurn', text: '岩場（茶色）や 雑木林（こい緑）に 立つと たおされにくい。まもりながら 虫を ふやそう。' },
    ],
  },

  {
    ...
    stage: 7,
    name: 'とどかない ところから',
    hint: 'ミイデラゴミムシは はなれた ところから うてる。はんげき を うけないぶん、動いたターンは うてないよ。',
    aiLevel: 1,
    ...
    units: [
      { x: 8, y: 10, type: 'ant', team: 'player' },
      { x: 9, y: 10, type: 'ant', team: 'player' },
      { x: 10, y: 10, type: 'bombardier', team: 'player' },
      { x: 7, y: 10, type: 'bombardier', team: 'player' },
      { x: 1, y: 2, type: 'ant', team: 'enemy' },
      { x: 2, y: 1, type: 'ant', team: 'enemy' },
      { x: 4, y: 1, type: 'kabuto', team: 'enemy' },
      { x: 3, y: 2, type: 'kabuto', team: 'enemy' },
    ],
    steps: [
      { on: 'start', text: 'ミイデラゴミムシは 2〜3マス はなれた 敵を うてる。かたい カブトムシに 有こうだよ。' },
      { on: 'select', text: '動いた ターンは うてない。うつ ターンは 動かさずに まとう。' },
    ],
  },

  {
    ...
    stage: 8,
    name: 'ひろい 草はら',
    hint: '広い野原での ぶつかりあい。樹液場を 多く とったほうが 虫を たくさん つくれるよ。',
    aiLevel: 1,
    startFunds: { player: 6000, enemy: 8000 },
    incomePerProperty: 1000,
    rows: [
      '..............',
      '.Q.N....S.....',
    ...
    owners: [
      { x: 1, y: 1, team: 'enemy' },
      { x: 3, y: 1, team: 'enemy' },
      { x: 8, y: 10, team: 'player' },
      { x: 10, y: 10, team: 'player' },
    ],
    units: [
      { x: 8, y: 11, type: 'ant', team: 'player' },
      { x: 9, y: 11, type: 'ant', team: 'player' },
      { x: 10, y: 11, type: 'kabuto', team: 'player' },
      { x: 7, y: 11, type: 'mantis', team: 'player' },
      { x: 1, y: 2, type: 'ant', team: 'enemy' },
      { x: 2, y: 1, type: 'ant', team: 'enemy' },
      { x: 4, y: 1, type: 'kabuto', team: 'enemy' },
      { x: 3, y: 2, type: 'mantis', team: 'enemy' },
    ],
  },

  {
    ...
    stage: 9,
    name: 'ふたつの 巣',
    hint: '巣が ふたつ ある。とれば 1ターンに 2ひき つくれるぞ。',
    aiLevel: 1,
    startFunds: 6000,
    incomePerProperty: 1000,
    rows: [
    ...
    units: [
      ...
      { x: 3, y: 2, type: 'mantis', team: 'enemy' },
      { x: 9, y: 10, type: 'ant', team: 'player' },
      { x: 11, y: 10, type: 'ant', team: 'player' },
      { x: 9, y: 9, type: 'kabuto', team: 'player' },
      { x: 11, y: 9, type: 'mantis', team: 'player' },
    ],
  },

  {
    ...
    stage: 10,
    name: '草はらの ぬし',
    hint: '大きな オオカマキリの 群れが 待ちうけている。カマキリは 空の虫も つかまえる。数で かこもう。',
    aiLevel: 1,
    // ボス面。敵は 強い虫を そろえているが、お金は こちらが ずっと 多い。
    // 「1体ずつ かこんで たおす」を おぼえる面。
    ...
    units: [
      { x: 8, y: 10, type: 'ant', team: 'player' },
      { x: 9, y: 10, type: 'ant', team: 'player' },
      { x: 10, y: 10, type: 'ant', team: 'player' },
      { x: 11, y: 10, type: 'kabuto', team: 'player' },
      { x: 7, y: 10, type: 'bombardier', team: 'player' },
      { x: 1, y: 2, type: 'mantis', team: 'enemy' },
      { x: 2, y: 1, type: 'mantis', team: 'enemy' },
      { x: 3, y: 2, type: 'mantis', team: 'enemy' },
      { x: 5, y: 1, type: 'kabuto', team: 'enemy' },
    ],
    steps: [
      { on: 'start', text: '世界1の さいご！ オオカマキリの 群れだ。1体ずつ かこんで たおそう。' },
    ],
  },
